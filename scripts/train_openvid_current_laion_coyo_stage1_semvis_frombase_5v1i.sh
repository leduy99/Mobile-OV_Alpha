...
export SMOLVLM2_MODEL_ID="${SMOLVLM2_MODEL_ID:-HuggingFaceTB/SmolVLM2-500M-Video-Instruct}"

CONFIG="${CONFIG_STAGE1_SEMVIS_500M:-configs/stage1_teacher_free_joint_openvid_current_laion_coyo_semvis_frombase_5v1i_2gpu_20260321.yaml}"
