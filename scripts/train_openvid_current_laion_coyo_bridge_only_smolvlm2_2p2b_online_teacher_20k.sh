...
export MASTER_PORT="${MASTER_PORT:-29833}"
export SMOLVLM2_MODEL_ID="${SMOLVLM2_MODEL_ID:-HuggingFaceTB/SmolVLM2-2.2B-Instruct}"

CONFIG="${CONFIG_STAGE1_BRIDGEONLY_2P2B:-configs/stage1_teacher_free_joint_openvid_current_laion_coyo_bridge_only_smolvlm2_2p2b_online_teacher_20k_2gpu_20260321.yaml}"
