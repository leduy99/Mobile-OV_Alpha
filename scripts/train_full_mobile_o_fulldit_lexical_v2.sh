...
mkdir -p output/logs
CONFIG_PATH="configs/stage1_full_mobile_o_fulldit_lexical_v2_bs64_8gpu.yaml"
RUN_ROOT="output/stage1_full_mobile_o_fulldit_lexical_v2_bs64_8gpu"
LOG_PATH="output/logs/train_full_mobile_o_fulldit_lexical_v2_bs64_8gpu.log"
MAX_GPUS="${MAX_GPUS:-8}"
EXTRA_ARGS=()
