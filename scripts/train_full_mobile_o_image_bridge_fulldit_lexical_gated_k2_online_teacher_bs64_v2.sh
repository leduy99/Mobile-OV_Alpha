...
mkdir -p output/logs
CONFIG_PATH="configs/stage1_teacher_free_full_mobile_o_image_bridge_fulldit_lexical_gated_k2_online_teacher_bs64_v2_8gpu_20260420.yaml"
RUN_ROOT="output/stage1_bridge_fulldit_full_mobile_o_smolvlm2_500m_lexical_gated_k2_online_teacher_bs64_v2_20260420_8gpu"
LOG_PATH="output/logs/train_full_mobile_o_image_bridge_fulldit_lexical_gated_k2_online_teacher_bs64_v2_8gpu.log"
MAX_GPUS="${MAX_GPUS:-8}"
EXTRA_ARGS=()
